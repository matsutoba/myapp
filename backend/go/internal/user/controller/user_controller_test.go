...
import (
	...
	controllers "github.com/matsubara/myapp/internal/user/controller"
	"github.com/matsubara/myapp/internal/user/dto"
	"github.com/matsubara/myapp/internal/user/service/mocks"
...
func TestUserController_GetUserByID(t *testing.T) {
	...
	mockUser := &domain.User{ID: uint(1), Name: "Taro", Email: "taro@example.com"}
...
func TestUserController_CreateUser(t *testing.T) {
	...
	newUser := &domain.User{ID: 1, Name: "Taro", Email: "taro@example.com"}
...
func TestUserController_CreateUser_Conflict_Returns409(t *testing.T) {
	...
	env.MockService.On("CreateUser", mock.AnythingOfType("dto.CreateUserRequest")).Return((*domain.User)(nil), commonerrors.AppErrUserAlreadyExists)
...
func TestUserController_UpdateUser(t *testing.T) {
	...
	updatedUser := &domain.User{ID: 1, Name: "Taro Updated", Email: "taro.updated@example.com", Role: "admin"}

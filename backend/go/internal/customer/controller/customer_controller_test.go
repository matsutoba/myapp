...
import (
	...
	controllers "github.com/matsubara/myapp/internal/customer/controller"
	"github.com/matsubara/myapp/internal/customer/dto"
	"github.com/matsubara/myapp/internal/customer/service/mocks"
...
func TestCustomerController_GetCustomers_Empty_Returns200(t *testing.T) {
	...
	env.MockService.On("GetAllCustomers").Return([]domain.Customer{}, nil)
...
func TestCustomerController_CreateCustomer(t *testing.T) {
	...
	body := `{"contactName":"New Co.","email":"new@example.com","address":"Nagoya","phone":"090-0000-0000"}`
...
func TestCustomerController_CreateCustomer_Conflict_Returns409(t *testing.T) {
	...
	body := `{"contactName":"Acme Inc.","email":"contact@acme.example","address":"Tokyo","phone":"000-1111"}`
	req, _ := http.NewRequest(http.MethodPost, "/customers", strings.NewReader(body))
	req.Header.Set("Content-Type", "application/json")
	w := httptest.NewRecorder()
	env.Router.ServeHTTP(w, req)
...
func TestCustomerController_UpdateCustomer(t *testing.T) {
	...
	body := `{"contactName":"Acme K.K.","email":"contact@acme.example","address":"Tokyo","phone":"000-9999"}`
